...
public class RabinMiller {
    ...
    public static ArrayList<BigInteger> findPrimes(Integer nums_to_test, BigInteger bottom, BigInteger top) {
        ArrayList<BigInteger> primes = new ArrayList<BigInteger>();
        for (int i = 0; i < nums_to_test; ++i) {
            BigInteger num = RabinMiller.uniformRandom(bottom, top);
            if (RabinMiller.isProbablePrime(num, 10)) {
                primes.add(num);
            }
        }
        return primes;
